...
* win-check oldrelease (https://win-builder.r-project.org/QX5pRlA0SD2T/00check.log)
* win-check release (https://win-builder.r-project.org/97899bFn6g78/00check.log)
* win-check devel (https://win-builder.r-project.org/s8rLM9ypK5xP/00check.log)
