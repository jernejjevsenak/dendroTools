...
```{r, fig.align='center', warning=FALSE, fig.width=7, fig.height=5, fig.cap=paste("Figure 4: The temporal correlations for pre-defined window of 60 days for past years")}
example_MVA_past$plot_specific
```

```{r, fig.align='center', warning=FALSE, fig.width=7, fig.height=5, fig.cap=paste("Figure 5: The temporal correlations for pre-defined window of 60 days for present years")}
...
plot(row.names(data_TRW), reconstruction$predictions, type = "l", xlab = "Year", ylab = "Average temperature May 15 - Jun 27 [ºC]")
```
